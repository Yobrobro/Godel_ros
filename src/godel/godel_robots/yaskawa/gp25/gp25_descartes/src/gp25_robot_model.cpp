...
#include <gp25_descartes/gp25_robot_model.h>
...
{
GP25RobotModel::GP25RobotModel()
    : world_to_base_(Eigen::Affine3d::Identity()), tool_to_tip_(Eigen::Affine3d::Identity())
{
}

bool GP25RobotModel::initialize(const std::string& robot_description,
...
bool GP25RobotModel::getAllIK(const Eigen::Affine3d& pose,
...
PLUGINLIB_EXPORT_CLASS(gp25_descartes::GP25RobotModel, descartes_core::RobotModel)
