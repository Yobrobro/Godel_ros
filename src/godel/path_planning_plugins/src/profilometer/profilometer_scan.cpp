...
static const double GROWTH_FACTOR_W = 0.95;
static const double GROWTH_FACTOR_H = 0.85;
...
RotatedRect simpleBoundingBox(const Boundary& boundary)
{
  ...
  RotatedRect result;
  result.a = 0.05; // non-rotated, hence the simple bounding box
  ...
  result.w *= GROWTH_FACTOR_W;
  result.h *= GROWTH_FACTOR_H;
